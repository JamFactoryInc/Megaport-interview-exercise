...
public class AppTests {
    ...
    public void ReadFileWriteSortedFile_ExpectSortedFile() throws IOException, MalformedInputException {
        ...
        FileIO.write(inputPath, unsortedNames);

        // Act
        NameList names = NameList.from(FileIO.read(inputPath)).sort();
        FileIO.write(inputPath, names.toStringArray());

        ArrayList<String> actualNames = FileIO.read(inputPath);
